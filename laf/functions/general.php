...
function cf_enqueue_styles() {
	...
	wp_enqueue_script( 'cf-script-legacy', get_stylesheet_directory_uri() . '/assets/js/main-legacy.min.js', array( 'jquery', 'jquery-mask' ), '1.0.0', true );
	wp_enqueue_style( 'cf-style', get_stylesheet_directory_uri() . '/assets/css/style.css', array( 'cf-style-legacy' ), '0.0.1' );
	wp_enqueue_script( 'cf-script', get_stylesheet_directory_uri() . '/assets/js/main.min.js', array( 'jquery', 'jquery-mask', 'cf-script-legacy' ), '0.0.1', true );
}
