...
class Cf_Admin {
	...
	private function __construct() {
		// Set our title
		$this->title = __( 'Configurações Extras', 'cf' );
	}
	...
	function add_options_page_metabox() {
		...
		$cmb->add_field( array(
			'name' => __( 'Analytics', 'cf' ),
			'id'   => 'titulo_analytics',
			'type' => 'title',
		) );
		
		$cmb->add_field( array(
			'name' => __( 'Id do Google Analytics', 'cf' ),
	...
	public function settings_notices( $object_id, $updated ) {
		...
		add_settings_error( $this->key . '-notices', '', __( 'Settings updated.', 'cf' ), 'updated' );
