...
<form action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post" class="woocommerce-cart-form m-b-0">
...
<?php if ( wc_coupons_enabled() ) : ?>
	<form class="checkout_coupon mb-0" method="post">
		<div class="coupon row row-small">
			<div class="col medium-6">
				<input type="text" name="coupon_code" class="input-text" id="coupon_code" value="" placeholder="<?php esc_attr_e( 'Coupon code', 'woocommerce' ); ?>" />
			</div>
			<!-- /.col medium-6 -->
			<div class="col medium-6">
				<input type="submit" class="is-form expand" name="apply_coupon" value="<?php esc_attr_e( 'Apply coupon', 'woocommerce' ); ?>" />
			</div>
			<!-- /.col medium-6 -->
