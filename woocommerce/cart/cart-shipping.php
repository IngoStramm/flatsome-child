...
<tr class="shipping">
	...
	<td data-title="<?php echo esc_attr( $package_name ); ?>">
		<?php if ( 1 < count( $available_methods ) ) : ?>
			<?php // mais de 1 método encontrado ?>
		...
		<?php elseif ( 1 === count( $available_methods ) ) :  ?>
			<?php // Apenas 1 método encontrado ?>
			<?php $posicao = is_cart() ? 'abaixo' : 'ao lado'; ?>
			<p><?php _e( 'Para mais opções de entrega, digite seu CEP no campo ' . $posicao . '.', 'cf' ); ?></p>
			<?php
		...
		<?php if ( ( is_cart() && ! $index ) /*|| ( is_checkout() && ! $index )*/ ) : ?>
